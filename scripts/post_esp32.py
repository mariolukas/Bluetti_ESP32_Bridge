...
# Modified version of: https://raw.githubusercontent.com/letscontrolit/ESPEasy/mega/tools/pio/post_esp32.py
#
...
def esp32_create_combined_bin(source, target, env):
    ...
    build_dir = "build"
    bin_name = "Bluetti_ESP32_Bridge"

    makedirs(build_dir, exist_ok=True)
    new_file_name = env.subst(f"{build_dir}/{bin_name}.factory.bin")
    ...
    esptool.main(cmd)
    copyfile(firmware_name, f"{build_dir}/{bin_name}.ota.bin")
